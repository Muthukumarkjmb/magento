...
class Interceptor extends \Magento\Quote\Model\QuoteValidator implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(?\Magento\Directory\Model\AllowedCountries $allowedCountryReader = null, ?\Magento\Quote\Model\Quote\Validator\MinimumOrderAmount\ValidationMessage $minimumAmountMessage = null, ?\Magento\Quote\Model\ValidationRules\QuoteValidationRuleInterface $quoteValidationRule = null, ?\Magento\Framework\Webapi\Rest\Response $response = null)
    {
        $this->___init();
        parent::__construct($allowedCountryReader, $minimumAmountMessage, $quoteValidationRule, $response);
    }
