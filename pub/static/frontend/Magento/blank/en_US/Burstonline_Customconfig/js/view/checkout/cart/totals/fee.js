define([
    ...
    var feeDetails = window.checkoutConfig.fee_details || {};
    var formattedFeeDetails = Object.entries(feeDetails)
        .map(function (item) {
            return '<div>' + item[0] + '<span style="float:right;"> $' + item[1] + '<span></div>';
        })
        .join('');
    ...
    return Component.extend({
        ...
        formattedFeeDetails: ko.observable(formattedFeeDetails),
