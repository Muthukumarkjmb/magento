...
return [
    'modules' => [
        ...
        'Burstonline_Businesshours' => 1,
        'Burstonline_Categoryhome' => 1,
        'Burstonline_Checkoutdisclaimer' => 1,
        'Burstonline_Customconfig' => 1,
        'Burstonline_Customhome' => 1,
        'Burstonline_Customsummary' => 1,
        'Burstonline_Disablecheckout' => 1,
        'Burstonline_Dynamicplaceholder' => 1,
        'Burstonline_Epipayment' => 1,
        'Burstonline_Feeconfig' => 1,
        'Burstonline_Importproduct' => 1,
        'Burstonline_RestrictAddToCart' => 1,
        'Burstonline_Saleablefilter' => 1,
        'Epi_ShippingRestriction' => 1,
        'Learn_Ageverify' => 1,
        ...
        'Plumrocket_LayeredNavigationLite' => 1
    ]
];
