...
class Menu extends \Magento\Catalog\Block\Navigation
{
    ...
    public function  getTreeCategories($categories, $itemPositionClassPrefix, $count='') // include Magic_Label and Maximal Depth
    {
        ...
        foreach($categories as $category) {
            ...
            $allCatClass="";if (str_contains(strtolower($category->getName()), 'all ')) {$allCatClass="browseallcat "; }
            $childClass .= ' category-item '. $allCatClass . $this->_getActiveClasses($category->getEntityId());
