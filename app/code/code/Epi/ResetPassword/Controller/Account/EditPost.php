...
namespace Epi\ResetPassword\Controller\Account;
...
class EditPost extends AbstractAccount implements CsrfAwareActionInterface, HttpPostActionInterface
{
    ...
    public function __construct(
        ...
        $writer = new \Zend_Log_Writer_Stream(BP . '/var/log/ResetPassword.log');
    ...
    {   
        $this->logger->info('Checking for Reset Password');
        /** @var Redirect $resultRedirect */
        $resultRedirect = $this->resultRedirectFactory->create();
    ...
    protected function changeCustomerPassword($email)
    {
        ...
        if ($this->getRequest()->getParam('change_password')) {
            ...
            $this->logger->info('Old Password '.print_r($currPass,true));
            $this->logger->info('New Password '.print_r($newPass,true));
            if ($currPass == $newPass) {
                throw new InputException(__('Cannot set your current password as new password.'));
            }
            if ($newPass != $confPass) {
